...
public class UniformLoadPropertiesFileCreatorTest implements PropertiesFileCreatorUtil {
    ...
    public void execute() throws Exception {
        ...
        UniformLoadPropertiesFileCreator creator = new UniformLoadPropertiesFileCreator();
